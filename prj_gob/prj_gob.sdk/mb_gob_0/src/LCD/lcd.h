...
#define SPI_DC          XPAR_LCD_SPI_DC_BASEADDR
#define B_RS            0x00000001

#define SPI_DTR         XPAR_LCD_SPI_BASEADDR + XSP_DTR_OFFSET
#define SPI_DRR         XPAR_LCD_SPI_BASEADDR + XSP_DRR_OFFSET
#define SPI_IISR        XPAR_LCD_SPI_BASEADDR + XSP_IISR_OFFSET
#define SPI_SR          XPAR_LCD_SPI_BASEADDR + XSP_SR_OFFSET
