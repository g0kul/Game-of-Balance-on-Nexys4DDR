...
HD_PWD='/home/davidmc/prep_new_ddr_cache_v2/prep_new_ddr_cache_v2.runs/system_axi_gpio_2_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_gpio_2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_gpio_2_1.tcl
