...
HD_PWD='/home/gokul/playground/xilinx/ece253lab/prj_gob/prj_gob.runs/system_axi_quad_spi_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_quad_spi_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_quad_spi_0_1.tcl
