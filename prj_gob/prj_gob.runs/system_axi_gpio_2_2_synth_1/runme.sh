...
HD_PWD='/home/gokul/playground/xilinx/del/lab2b/lab2b_lcd.runs/system_axi_gpio_2_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_gpio_2_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_gpio_2_2.tcl
